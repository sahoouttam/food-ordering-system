...
public class Order extends AggregateRoot<OrderId> {
    ...
    public void approve() {
        if (orderStatus != OrderStatus.PAID) {
            throw new OrderDomainException("Order is not is correct state for approval");
        }
    ...
    public void initCancel(List<String> failureMessages) {
        if (orderStatus != OrderStatus.PAID) {
            throw new OrderDomainException("Order is not is correct state for initCancel operation!");
        }
    ...
    public void cancel(List<String> failureMessages) {
        if (!(orderStatus == OrderStatus.PAID || orderStatus == OrderStatus.PENDING)) {
            throw new OrderDomainException("Order is not is correct state for cancel operation!");
        }
